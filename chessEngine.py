#where we store all the information about the current state of a chess game. also responsible for determinint the valid moves of the current state. 
#it will also keep a move log

class GameState():
    def __init__(self):
        #board is 8x8 two dimensional list and each element has 2 characters
        #the firsst character represents the color of the piece, "b" or "w"
